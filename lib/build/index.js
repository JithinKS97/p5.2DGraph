...
var Graph2D = /** @class */ (function () {
    function Graph2D(config) {
        ...
        this.handleMouseWheel = function (e) {
            ...
            _this.resetIsZoomParamsWhenFinished();
            var xp = e.clientX - _this.pos.x;
            var yp = e.clientY - _this.pos.y;
            if (e.deltaY >= 0) {
                _this.zoom("in", xp, yp);
            }
            else {
                _this.zoom("out", xp, yp);
            }
        };
        ...
        this.resetIsZoomParamsWhenFinished = function () {
     ...
     */
    Graph2D.prototype.zoom = function (mode, xp, yp) {
        var scaleRate = 1;
        if (mode === "in") {
            scaleRate = 1.05;
        }
